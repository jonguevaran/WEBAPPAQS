const buttons = document.querySelectorAll('button[data-page]');
        ...
        function setActiveButton(activeButton) {
            ...
            activeButton.classList.remove('bg-white/20', 'dark:bg-black/20', 'text-slate-600', 'dark:text-slate-300');
            activeButton.classList.add('bg-blue-200', 'text-white', 'dark:bg-blue-200', 'active');
        }
